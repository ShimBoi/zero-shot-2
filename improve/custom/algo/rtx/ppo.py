...
class PPO(Agent):
    def __init__(
        ...
        self._is_image_obs = self.cfg.get("is_image_obs", False)
    ...
    def act(self, states: Union[np.ndarray, jax.Array], timestep: int, timesteps: int) -> Union[np.ndarray, jax.Array]:
        ...
        actions, log_prob, outputs = self.model.act({"states": self._state_preprocessor(states)}, role="rollout")
    ...
    def record_transition(
        ...
        values: Union[np.ndarray, jax.Array],
    ...
    def _update(self, timestep: int, timesteps: int) -> None:
        ...
        for batch in ds:
            ...
            self.optimizer = self.optimizer.step(
                {"params": grads['params']}, self.model, self._learning_rate if self._learning_rate_scheduler else None
            )
